...
if __name__ == '__main__':
    ...
    config_files = [
        ...
        # 'ultralytics/cfg/models/11/yolo11-GhostHGNetV2_SimAm.yaml',
        # 'ultralytics/cfg/models/11/yolo11-GhostHGNetV2_MPCA_LSCD.yaml',
        # 'ultralytics/cfg/models/11/yolo11-GhostHGNetV2_MPCA.yaml'
        ...
        # 'ultralytics/cfg/models/11/yolo11-attention.yaml'
    ...
    for config_file in config_files:
        ...
        model.train(data='data_congcaiFour.yaml',
                    # resume=True,
                    cache=False,
                    imgsz=640,
                    epochs=300,
